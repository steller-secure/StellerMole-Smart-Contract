...
pub trait IReferral<TContractState> {
    ...
    fn get_user_referral_codes(self: @TContractState, user: ContractAddress) -> Array<felt252>;
    fn get_user_referrals(self: @TContractState, user: ContractAddress) -> Array<ContractAddress>;
    ...
    fn update_reward_amounts(ref self: TContractState, referrer_reward: u256, referee_reward: u256);
