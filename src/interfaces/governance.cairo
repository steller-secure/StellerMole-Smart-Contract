...
pub trait IGovernance<TContractState> {
    ...
    // View functions
    fn get_proposal(self: @TContractState, proposal_id: u256) -> super::super::types::governance::Proposal;
    ...
    fn get_votes(self: @TContractState, proposal_id: u256) -> (u256, u256, u256); // for, against, abstain
