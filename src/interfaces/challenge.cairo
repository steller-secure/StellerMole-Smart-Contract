...
pub trait IChallengeScheduler<TContractState> {
    ...
    fn get_historical_challenges(self: @TContractState, start_index: u32, count: u32) -> Array<Challenge>;
    fn get_challenge_participants(self: @TContractState, challenge_id: u32) -> Array<ChallengeParticipant>;
    fn is_participant(self: @TContractState, challenge_id: u32, participant: ContractAddress) -> bool;
    fn get_participant_score(self: @TContractState, challenge_id: u32, participant: ContractAddress) -> u128;
